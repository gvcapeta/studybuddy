...
<aside class="collapse show" id="collapseWidthExample">
    <div class="aside">
        ...
        <ul>
            ...
            <li>
                <a class="active" href="chat.php" style="text-decoration: none;" >
...
############ SIDEBAR HTML CODE : END ############-->
        <!-- <header>
    <div class="htop" style="background:rgb(71, 114, 86);width: 300px;color: #fff;">
        <h1>StudyBuddy</h1>
        <a class="menu-toggle" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample" aria-expanded="false">
        <span></span>
        </a>
    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="chat.php" method="post" id="delete_form">
                            <div class="room_list">
                                <div class="row" style="background: #c7d6bf;color: #39493e;">
                                    <div class="col-md-6">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $(document).on('click', '.sendFile', function() {
                    var file_input = $('#file_upload_input');
                    file_input.click();
                });

                $(document).on('input', '#file_upload_input', function() {
                    console.log($('#file_upload_input').val());
                    if ($('#file_upload_input').val() != '') {
                        var id = $('.chat_room_id').val();
                        var fd = new FormData();
                        fd.append('file', $('#file_upload_input').get(0).files[0]);
                        fd.append('id', id);
